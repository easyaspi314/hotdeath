...
public class ComputerPlayer extends Player
{
    ...
    {
        m_numCardsToDeal = Game.rng.nextInt(11) + 5;
    }
    ...
    public void playCard()
    {
        ...
        if (bestcard == null)
        {
            ...
            for (int i = 0; i < m_hand.getNumCards(); i++)
            {
                ...
                //   - don't throw MAD when point count in hand is too high (unless player count
                // < 4)
                //   - consider the damage of offensive cards; look to hit players with low card
                // counts
                //   - advanced: throw the MAD card to catch an opponent and force him over 1000
                // points,
                ...
                if (this.m_skill >= 1)
                {
                    ...
                    if ((tc.getID() == Card.ID_YELLOW_1_MAD) && (m_game.getActivePlayerCount() >
                                                                 3))
                    {
                    ...
                    {
                        // You've GOT to throw the mystery draw on a 69!  That's the whole fun of
                        // the
                        // game.  You want to avoid throwing it on non-numbered cards, and the
                        // higher the
                ...
                if (this.m_skill >= 2)
                {
                    ...
                    if (considerColorBalance)
                    {
                        ...
                        //Log.d("HDU", "   - colorbalanceimprovement: " + colorBalanceImprovement
                        // + ", testval: " + testval);
