...
public class Game extends Thread
{
        ...
        if (android.os.Debug.isDebuggerConnected() && debugDeal)
        {
            int[][] hands = {
				...
				*/
				...
				{Card.ID_BLUE_0_FUCKYOU, Card.ID_GREEN_0_QUITTER, Card.ID_YELLOW_0_SHITTER, Card
				.ID_RED_0_HD, Card.ID_BLUE_1, Card.ID_BLUE_2, Card.ID_BLUE_3},
				{Card.ID_GREEN_1, Card.ID_GREEN_2, Card.ID_GREEN_3, Card.ID_GREEN_4, Card
				.ID_GREEN_5, Card.ID_GREEN_6, Card.ID_GREEN_7},
				{Card.ID_RED_1, Card.ID_RED_2, Card.ID_RED_3, Card.ID_RED_4, Card.ID_RED_5, Card
				.ID_RED_6, Card.ID_RED_7},
				{Card.ID_YELLOW_1, Card.ID_YELLOW_2, Card.ID_YELLOW_3, Card.ID_YELLOW_4, Card
				.ID_YELLOW_5, Card.ID_YELLOW_6, Card.ID_YELLOW_7}
				*/
				...
				{Card.ID_YELLOW_3, Card.ID_YELLOW_4, 
						Card.ID_RED_1, Card.ID_RED_2, Card.ID_RED_3, Card.ID_RED_4, Card.ID_RED_5,
						 Card.ID_RED_6, Card.ID_RED_7, Card.ID_RED_8, Card.ID_RED_D, Card
						 .ID_RED_R, Card.ID_RED_S, Card.ID_RED_S_DOUBLE, Card.ID_RED_R_SKIP,
						Card.ID_GREEN_1, Card.ID_GREEN_2, Card.ID_GREEN_3, Card.ID_GREEN_4, Card
						.ID_GREEN_5, Card.ID_GREEN_6, Card.ID_GREEN_7, Card.ID_GREEN_8, Card
						.ID_GREEN_9, Card.ID_GREEN_D, Card.ID_GREEN_R, Card.ID_GREEN_S, Card
						.ID_GREEN_S_DOUBLE, Card.ID_GREEN_R_SKIP,
						Card.ID_BLUE_1, Card.ID_BLUE_2, Card.ID_BLUE_3, Card.ID_BLUE_4, Card
						.ID_BLUE_5, Card.ID_BLUE_6, Card.ID_BLUE_7, Card.ID_BLUE_8, Card
						.ID_BLUE_9, Card.ID_BLUE_D, Card.ID_BLUE_R, Card.ID_BLUE_S, Card
						.ID_BLUE_S_DOUBLE, Card.ID_BLUE_R_SKIP
				},
				...
				{Card.ID_YELLOW_3, Card.ID_YELLOW_4, 
					Card.ID_RED_1, Card.ID_RED_2, Card.ID_RED_3, Card.ID_RED_4, Card.ID_RED_5,
					Card.ID_RED_6, Card.ID_RED_7, Card.ID_RED_8, Card.ID_RED_9, Card.ID_RED_D,
					Card.ID_RED_R, Card.ID_RED_S, Card.ID_RED_S_DOUBLE, Card.ID_RED_R_SKIP,
					Card.ID_BLUE_1, Card.ID_BLUE_2, Card.ID_BLUE_3, Card.ID_BLUE_4, Card
					.ID_BLUE_5, Card.ID_BLUE_6, Card.ID_BLUE_7, Card.ID_BLUE_8, Card.ID_BLUE_9,
					Card.ID_BLUE_D, Card.ID_BLUE_R, Card.ID_BLUE_S, Card.ID_BLUE_S_DOUBLE, Card
					.ID_BLUE_R_SKIP
				},
				{Card.ID_YELLOW_1, Card.ID_YELLOW_2}, 
				{Card.ID_GREEN_1, Card.ID_GREEN_2, Card.ID_GREEN_3, Card.ID_GREEN_4, Card
				.ID_GREEN_5, Card.ID_GREEN_6, Card.ID_GREEN_7, Card.ID_GREEN_8, Card.ID_GREEN_9,
				Card.ID_GREEN_D, Card.ID_GREEN_R, Card.ID_GREEN_S, Card.ID_GREEN_S_DOUBLE, Card
				.ID_GREEN_R_SKIP},
				...
				*/
				...
				{Card.ID_YELLOW_69, Card.ID_YELLOW_0_SHITTER, Card.ID_WILD_DRAWFOUR, Card
				.ID_WILD_DRAWFOUR},
				{Card.ID_RED_1},
				{Card.ID_RED_2},
    ...
    public int rolloverDiscardPile()
    {
        ...
        if (numPlayedCards > 1)
        {
            ...
            promptUser(getQuantityString(R.plurals.msg_shuffling_discard,
                                         numPlayedCards - 1, numPlayedCards - 1));
            ...
            if (m_currPlayer.getWantsToPlayCard())
            {
                ...
                if (m_penalty.getType() != Penalty.PENTYPE_NONE)
                {
                    ...
                    else
                    {
                        ...
                        if (ndef > 0 && m_currPlayer instanceof HumanPlayer)
                        {
                            promptUser(getQuantityString(R.plurals.msg_you_have_defender, ndef, ndef));
                        }
                        else
                        {
                            assessPenalty();
    ...
    */
    ...
    {
        return m_gt.getContext().getResources().getQuantityString(resid, quantity, args);
    }
