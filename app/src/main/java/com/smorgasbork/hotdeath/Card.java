...
public class Card
{
    ...
    public Card(int deckIndex, int Color, int Value, int ID, int PointValue, double PointMultiplier,
                int CumulativePenalty, int HighestCardMatch)
    {
    ...
    /*	public static Card generateCard(int color, int value) {
            int id = 0;
            int points = value;
            switch (color) {
                case COLOR_RED: id = ID_RED_0; break;
                case COLOR_GREEN: id = ID_GREEN_0; break;
                case COLOR_BLUE: id = ID_BLUE_0; break;
                case COLOR_YELLOW: id = ID_YELLOW_0; break;
                default: id = ID_WILD;
            }
            if (value <= 12 && id != ID_WILD) {
                id += value;
                if (value <= 10) {
                    points += 1;
                }
